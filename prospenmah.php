                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php 
                                            $cari = $_POST['cari'];
                                            $sql = "SELECT * FROM tb_mahasiswa WHERE id LIKE '%$cari%' OR nama LIKE '%$cari%'";
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="mahasiswa_edit.php?id=<?php echo $row['id']; ?>"><button class="btn btn-primary">Ubah</button></a> <a href="hapus.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
