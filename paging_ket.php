...
$data = mysqli_query($koneksi, "SELECT * FROM tb_ket");
$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas);

$data_mahasiswa = mysqli_query($koneksi, "SELECT * FROM tb_ket LIMIT $halaman_awal, $batas");
 ...
 ?>
  ...
  <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['bukti']!='') {
                                                        echo "<img src=\" mahasiswa/modul/mahasiswa/images/$row[bukti]\" />";
                                                    }else{
                                                        echo "images";
                                                    }
