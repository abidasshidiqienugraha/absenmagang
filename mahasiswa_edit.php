...
<form action="proedit_mahasiswa.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Universitas / Sekolah</label>
    <input type="text" class="form-control" name="universitas" autocomplete="off" value="<?php echo $d['universitas/sekolah'];?>">
  </div>
    <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="tanggalkeluar" autocomplete="off" value="<?php echo $d['tanggalkeluar'];?>">
  </div>
    <div class="form-group">
