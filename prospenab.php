                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                              <?php 
                                            $cari = $_POST['cari'];
                                            $sql = "SELECT * FROM tb_kehadiran WHERE nobp LIKE '%$cari%' OR namamahasiswa LIKE '%$cari%'";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['tanggalkehadiran']; ?></td>
                                                <td><?php echo $row['status']; ?></td>
                                                
                                                    

                                                </td>
                                                <td> <a href="absen/hapus_kehadiran.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
